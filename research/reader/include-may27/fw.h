/* GENERATED by mkfwh.py -- do not edit.
 * reference: fw_code_full.bin
 * target:    dev2_fw0_sys_plain.bin
 * 22 address(es) relocated, 1 unchanged.
 * Addresses inside comments are the REFERENCE build's and are
...
#define fw_memset  ((void *(*)(void *, int, unsigned))0x100f1f27)
/* [OBSERVED] _decode_one_page: memcpy(sp+0xc, filebuf, len) */
#define fw_memcpy  ((void *(*)(void *, const void *, unsigned))0x100f1f1f)

/* --- logging ---------------------------------------------------------- */
/* [OBSERVED] printf-like: (fmt, s1, s2, value); reaches the UART console */
#define fw_log     ((void (*)(const char *, const char *, const char *, int))0x100ee667)

/* --- LVGL wrappers ---------------------------------------------------- */
/* [OBSERVED] _reading_create_content label loop */
#define lv_obj_set_size   ((void (*)(void *, int16_t, int16_t))0x100f805f)
#define lv_obj_set_pos    ((void (*)(void *, int16_t, int16_t))0x100f7fe9)
/* [OBSERVED] confirmed on hardware: child0.y1 == 24 as measured */
#define lv_obj_get_child  ((void *(*)(void *, uint32_t))0x100f98df)
/* [OBSERVED] confirmed on hardware: returned 18 as measured */
#define lv_obj_child_cnt  ((uint32_t (*)(void *))0x100f98fd)
#define lv_label_set_text ((void (*)(void *, const char *, int))0x100ec553)
/* [INFERRED] style property getter: (obj, part, prop) -> value; 0x1004 = height */
#define lv_get_style_prop ((int32_t (*)(void *, uint32_t, uint32_t))0x100f8ff1)
...
#define fs_open  ((int (*)(fs_file_t *, const char *, uint8_t))0x1007fb85)
/* [OBSERVED] "%sfile close error (%d)" */
#define fs_close ((int (*)(fs_file_t *))0x1007fcdd)
/* [OBSERVED] "%sfile read error (%d)" */
#define fs_read  ((int (*)(fs_file_t *, void *, uint32_t))0x1007fd19)
/* [OBSERVED] "%sfile seek error (%d)" */
#define fs_seek  ((int (*)(fs_file_t *, int32_t, int))0x1007fdbd)
...
#define fw_font_close ((int (*)(void *))0x100e14e9)
...
#define lv_mem_alloc ((void *(*)(uint32_t))0x100a0621)
...
#define fw_measure ((void (*)(const char *, int, int, void *, int, int *))0x100eb495)
...
#endif /* FW_H */
#define lv_event_get_code ((uint32_t (*)(void *))0x100f684d)   /* [OBSERVED] reading scroll cb tests its result against 0x0b = LV_EVENT_SCROLL */
...
#define fw_glyph_dsc ((int (*)(void *, void *, uint32_t, uint32_t))0x100e1325)
...
#define fs_write ((int (*)(fs_file_t *, const void *, uint32_t))0x1007fd51)
...
#define lv_label_set_text_copy ((void (*)(void *, const char *))0x100fe921)

/* Widget classes, read live from the running scene. */
#define LV_CLASS_OUR_LINES   0x10129b34u   /* the 18 reading labels        */
#define LV_CLASS_COUNTER_IN  0x1012c7d0u   /* leaf inside the page counter */
